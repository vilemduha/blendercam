...
def setup_4_axis(o):
    """Initialize variables common to all 4 axis operations.

    This function checks rotary axis settings and sets up operation
    variables to be used by 4 axis strategies.

    Args:
        o (object): An object containing parameters for the machining operation,
