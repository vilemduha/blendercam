...
class PrintSettings(bpy.types.PropertyGroup):
	...
	mm=0.001
	layer_height=bpy.props.FloatProperty(name="layer_height", default=0.15 * mm, min=0.00001, max=320000,precision=PRECISION, unit='LENGTH')
	...
	nozzle_size =  bpy.props.FloatProperty(name="laser_diameter", default=0.4 * mm, min=0.00001, max=320000,precision=PRECISION, unit='LENGTH')
