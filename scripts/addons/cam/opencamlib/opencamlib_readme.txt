Fabex OpenCAMLib support currently allows high quality, multithreaded sampling for 3-axis operations (parallel, spiral, etc.) and generation of waterlines.
Known issues:
...
https://github.com/vilemnovak/blendercam/wiki/Using-Fabex-with-OpenCAMLib
