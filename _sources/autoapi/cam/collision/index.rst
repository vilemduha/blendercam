...
.. autoapisummary::
   ...
   cam.collision.get_cutter_bullet
   cam.collision.subdivide_long_edges
   cam.collision.prepare_bullet_collision
   cam.collision.cleanup_bullet_collision
   cam.collision.get_sample_bullet
   cam.collision.get_sample_bullet_n_axis
