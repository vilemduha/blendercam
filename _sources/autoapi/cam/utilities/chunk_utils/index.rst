...
.. py:module:: cam.utilities.chunk_utils
...
.. autoapisummary::
   ...
   cam.utilities.chunk_utils.chunks_refine
   cam.utilities.chunk_utils.chunks_refine_threshold
   cam.utilities.chunk_utils.chunk_to_shapely
   cam.utilities.chunk_utils.mesh_from_curve
   cam.utilities.chunk_utils.make_visible
   cam.utilities.chunk_utils.restore_visibility
   cam.utilities.chunk_utils.chunks_to_shapely
   cam.utilities.chunk_utils.set_chunks_z
   cam.utilities.chunk_utils.rotate_point_by_point
   cam.utilities.chunk_utils._internal_x_y_distance_to
   cam.utilities.chunk_utils._optimize_internal
   cam.utilities.chunk_utils.optimize_chunk
   cam.utilities.chunk_utils.parent_child_distance
   cam.utilities.chunk_utils.parent_child
   cam.utilities.chunk_utils.parent_child_poly
   cam.utilities.chunk_utils.extend_chunks_5_axis
   cam.utilities.chunk_utils.get_closest_chunk
