...
.. autoapisummary::
   ...
   cam.gcode_path.point_on_line
   cam.gcode_path.export_gcode_path
   cam.gcode_path.get_path
   cam.gcode_path.get_change_data
   cam.gcode_path.check_memory_limit
   cam.gcode_path.get_path_3_axis
   cam.gcode_path.get_path_4_axis
