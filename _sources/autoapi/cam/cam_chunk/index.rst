...
.. autoapisummary::
   ...
   cam.cam_chunk.chunks_coherency
   cam.cam_chunk.limit_chunks
   cam.cam_chunk.mesh_from_curve_to_chunk
   cam.cam_chunk.curve_to_chunks
   cam.cam_chunk.shapely_to_chunks
   cam.cam_chunk.curve_to_shapely
   cam.cam_chunk.sample_chunks_n_axis
   cam.cam_chunk.sample_path_low
   cam.cam_chunk.polygon_boolean
   cam.cam_chunk.polygon_convex_hull
   cam.cam_chunk.silhouette_offset
   cam.cam_chunk.get_object_silhouette
   cam.cam_chunk.get_operation_silhouette
   cam.cam_chunk.get_object_outline
   cam.cam_chunk.get_ambient
   cam.cam_chunk.sample_chunks
   cam.cam_chunk.connect_chunks_low
   cam.cam_chunk.sort_chunks
   cam.cam_chunk.oclResampleChunks
   cam.cam_chunk.oclGetWaterline
   cam.cam_chunk.image_edge_search_on_line
   cam.cam_chunk.get_offset_image_cavities
   cam.cam_chunk.crazy_stroke_image
   cam.cam_chunk.crazy_stroke_image_binary
   cam.cam_chunk.image_to_chunks
   cam.cam_chunk.image_to_shapely
